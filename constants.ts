...
export const NEXT_PUBLIC_IS_BUILD = !!process.env.NEXT_PUBLIC_IS_BUILD as boolean;
...
export const CHART_COLORS_MAIN_ALL = [
  CHART_COLOR_1_MAIN,
  CHART_COLOR_BUY_MAIN,
  CHART_COLOR_PROLONG_MAIN,
  CHART_COLOR_PURCHASE_MAIN,
  CHART_COLOR_MARGE_MAIN,
  CHART_COLOR_6_MAIN,
]