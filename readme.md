```
yarn add moment @mui/lab formik yup yup-locales usehooks-ts formik-mui node-cache material-ui-confirm material-react-table @mui/x-date-pickers react-toastify @reduxjs/toolkit slugify react-dropzone
```
