  ...
  return <OriginalBreadcrumbs
    ...
    transformLabel={title => {
      switch (title) {
        ...
        case "assort": return "Ассортимент";
        ...
        case "main": return "Общая информация";
        case "content": return "Контент";
        case "new-user": return "Новый пользователь";
        case "new-order": return "Новый заказ";
        case "new-assort": return "Новая страница ассортимента";
        case "new-coupon": return "Новый купон";
        case "new": return "Новый элемент";
        default: return transformLabel(title);
      }
    }}
    {...props}
  />
